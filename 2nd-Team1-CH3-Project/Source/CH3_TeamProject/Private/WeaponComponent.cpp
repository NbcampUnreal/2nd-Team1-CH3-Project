...
void UWeaponComponent::Fire()
{
	...
	//GetWorld()->GetTimerManager().SetTimer(FireTimerHandle, this, &UWeaponComponent::ResetFire, FireRate, false);
}
...
bool UWeaponComponent::AttachWeapon(AMyCharacter* TargetCharacter)
{
